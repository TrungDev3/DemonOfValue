...
public class UnitController : MonoBehaviour
{
    ...
    // Phương thức AssignTargetUnits nhận vào một danh sách các đối tượng UnitController và chuyển chúng cho phương thức AddTargetUnits của targetsBehaviour.
    public void AssignTargetUnits(List<UnitController> units)
    {
        // Gọi phương thức AddTargetUnits từ đối tượng targetsBehaviour và truyền danh sách units vào phương thức đó.
